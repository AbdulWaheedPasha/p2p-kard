<<<<<<< HEAD:django-backend/core/views.py
...
from .api_serializers import CampaignDetailResponseSerializer, DashboardResponseSerializer, HomeResponseSerializer
...
class HomeView(APIView):
    ...
    def get(self, request):
        ...
        serializer = HomeResponseSerializer(
            context={"campaigns": campaigns, "contributions": contributions}
        )
...
class DashboardView(APIView):
    ...
    def get(self, request):
        ...
        serializer = DashboardResponseSerializer(
            context={"contributions": contributions, "borrow_requests": borrow_requests}
        )
        return Response(serializer.data)
...
class HealthView(APIView):
    ...
    def get(self, request):
        return Response({"ok": True, "version": "v1"})
>>>>>>> 0185501 (p2p Backend):core/views.py
